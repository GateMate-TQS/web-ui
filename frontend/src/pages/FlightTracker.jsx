            ...
            <div>
              ...
              <div className="mt-3">
                ...
                >
                  ...
                  {flights &&
                    [
                      ...new Set(flights.map((flight) => flight.origin.iata)),
                    ].map((uniqueIata) => (
                    ...
                    <Popup>
                      ...
                      >
                        <div className="flex flex-col">
                          ...
                          <div className="text-sm">
                            Arrival Airport Iata: {flight.destination.iata}
                          </div>
                          <div className="text-sm">
                            Departure Airport Iata: {flight.origin.iata}
                          </div>
                          <div className="text-sm">
                            Direction: {flight.liveData.direction}
                          </div>
                          <div className="text-sm">
                            Horizontal Speed: {flight.liveData.speedHorizontal}
                          </div>
                          <div className="text-sm">
                            Vertical Speed: {flight.liveData.speedVertical}
                          </div>
                        </div>
                      </Link>
                    </Popup>
